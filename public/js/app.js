...
deleteForms.forEach(function (form) {
  form.addEventListener('submit', function (e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/cart/remove-pizza', {
      pizzaId: pizzaId
    }).then(function (res) {
      console.log(res);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_0__.loadStripe)('pk_test_51NqeYcSALMIYEQufUuunqdLMQEW87NX55ytHDdpBylyBYQC2A4MWFe6gHklpNQLIMY8W8AmLk7ntDjBnr4ZhwK7000eAmfknPd');
        case 3:
